            ...
            <div style={{ padding: '0 10%', textAlign: 'left' }} >
                ...
                <p className=' text-justify pb-10'>
                    <div className=' mt-10 mb-5'>
                        <p className=' text-2xl pb-4 text-green-800 font-semibold'>Submission Methods:</p>
                        <li><a href=''>Online Submission System</a></li>
                        <li>Send via mail: smet2024@nitkkr.ac.in</li>
                    </div>
                    <div className=' mt-10 mb-5'>
                        <p className=' text-2xl pb-4 text-green-800 font-semibold'>Full Paper Submission <a href=''>( LINK HERE )</a></p>
                        <div className='pb-2'>
                    ...
                    <div className=' mt-10 mb-5'>
                        <div>
                        <p className=' text-2xl pb-4 text-green-800 font-semibold'>Abstract Submission</p>
                            <p>
                    ...
                    <div className=' mt-10 mb-10'>
                        <p className=' text-2xl pb-4 text-green-800 font-semibold'>Important Dates</p>
                        <table  style={{  borderCollapse: 'collapse',  backgroundColor: 'white' }}>
                            <tr>
                                <td style={{ border: '1px solid black', padding: '14px' }}  >Submission Deadline</td>
                                <td style={{ border: '1px solid black', padding: '14px' }}  >January 11, 2024</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style={{ border: '1px solid black', padding: '14px' }}  >Registration Deadline</td>
                                <td style={{ border: '1px solid black', padding: '14px' }}  >February 2, 2024</td>
                            </tr>
                        </table>
                    </div>
                </p>
