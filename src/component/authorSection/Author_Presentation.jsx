...
const Author_Presentation = () => {
    return (
        <div className=' bg-white text-black pb-5 mr-5 ml-5'>
            ...
            <div style={{ padding: '0 10%', textAlign: 'left' }} >
                ...
                <div className=' mt-4 mb-8'>
                    <p className=' font-medium mb-2'>Tips for a Good Presentation</p>
                    <p className='text-sm'>Whether you are a seasoned presenter or a nervous first-timer, the following tips are intended as a simple guide.</p>
                </div>
                <div className=' mt-4 mb-8'>
                    <p className=' font-medium mb-2 '>What to Bring</p>
                    <p className='text-sm'>Bring your presentation on a USB drive, bring a copy on a second USB as a back-up and email the file to yourself ahead of time in case of loss or failure. In addition, you may bring along printed copies of your presentation, your full paper or other handouts, to distribute to audience members. We also recommend that you bring business cards.</p>
                </div>
                <div className=' mt-4 mb-8'>
                ...
                <div>
                    <p>Important: Please ensure that the file name of your presentation begins with your own name or Paper ID, rather than naming the file “ICMSN” or “UK”. This ensures you don’t waste valuable presentation time searching for the file.</p>
                </div>
                <div className=' mt-4 mb-8'>
                    <p className=' font-medium mb-2 '>What to Wear</p>
                    <p className='text-sm'>There is no official dress code, but delegates generally wear business casual. However, professional attire is appreciated by fellow professionals, so we suggest erring on the smart side – although a tie is not necessary!</p>
                </div>
                <div className=' mt-4 mb-8'>
                    <p className=' font-medium mb-2 '>Timing</p>
                    <p className='text-sm'>Aim to arrive the conference room at least a few minutes in advance before the session starts. Time is of vital importance in making a presentation, so please be aware of the overall length of your presentation, as well as how the time is divided within your presentation, to ensure that you leave the appropriate amount of time for each point.</p>
                </div>
                <div className=' mt-4 mb-8'>
                    <p className=' font-medium mb-2 '>How Long Is the Ideal Presentation?</p>
                    <p className='text-sm'>You have a 15-minute slot allocated in which to present, but your presentation itself should be no longer than 15 minutes. We would suggest aiming for around 12–13 minutes. This will allow ample time for directly engaging with the audience through discussion and questions.</p>
                </div>
                <div className=' mt-4 mb-8'>
                    <p className=' font-medium mb-2 '>Practice Makes Perfect</p>
                    <p className='text-sm'>Long before the conference, make sure you spend ample time distilling and crafting your ideas into a well-thought-out presentation. Do NOT just read out your paper – a well-written paper does not equal an interesting and effective presentation.
